...
routerPreguntasUsuario.get('/getAllPreguntasUsuario', validarToken_1.validarToken, preguntas_usuario_controller_1.getAllPreguntasUsuario); //Inicia sesión en la DB
routerPreguntasUsuario.post('/getPreguntasusuario', validarToken_1.validarToken, preguntas_usuario_controller_1.getPreguntasusuario); //Inserta un usuario en la DB
...
routerPreguntasUsuario.put('/updatePreguntaUsuario', validarToken_1.validarToken, preguntas_usuario_controller_1.updatePreguntaUsuario); // Actualiza las preguntas por el usuario seleccionado
