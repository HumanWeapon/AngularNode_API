...
routerPyme.post('/getPyme', validarToken_1.default, pyme_controller_1.getPyme); // obtiene la Pyme especificada
...
routerPyme.get('/getOnePyme/:id', validarToken_1.default, pyme_controller_1.getOnePyme); //Obtiene la PYME por el nombre
