...
routerOpEmpresa.post('/getOpEmpresa', validarToken_1.default, operacionEmpresas_controller_1.getOpEmpresa); // Obtiene la Empresa especificada
routerOpEmpresa.post('/postOpEmpresa', validarToken_1.default, operacionEmpresas_controller_1.postOpEmpresa); //Inserta una nueva Empresa en la Base de Datos
