...
routerContactoTelefono.get('/telefonosconcontacto', validarToken_1.default, Telefonos_controller_1.telefonosconcontacto); //consulta todas los telefonos con el contacto activo de la DBA.
routerContactoTelefono.get('/telefonosdeContactosPorId/:id', validarToken_1.default, Telefonos_controller_1.telefonosdeContactosPorId); //consulta todas los contactos en la base de datos
