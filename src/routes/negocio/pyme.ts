...
routerPyme.post('/getPyme', validarToken, getPyme); // obtiene la Pyme especificada
...
routerPyme.get('/getOnePyme/:id',validarToken, validarTokenpyme, getOnePyme);//Obtiene la PYME por el nombre
