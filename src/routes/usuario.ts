...
routerUser.post('/getUsuario',validarToken, getUsuario); // obtiene el usuario especificado
...
routerUser.post('/updateUsuario',validarToken, updateUsuario);//Activa un usuario en la DB
