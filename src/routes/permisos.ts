...
import { activatePermiso, deletePermiso, getAllPermisos, getPermiso, inactivatePermiso, permisosRolesObjetos, postPermiso, updatePermisos } from '../controllers/permisos-controller';
