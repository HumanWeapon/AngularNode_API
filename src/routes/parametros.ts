...
import { updateParametro, deleteParametro, postParametro, getAllParametros, getParametro, inactivateParametro, activateParametro, getParametroPreguntasdeSeguridad, getParametroPuertoCorreo } from '../controllers/parametros-controller';
