...
import { updateParametro, deleteParametro, postParametro, getAllParametros, getParametro, inactivateParametro, activateParametro, getParametroPreguntasdeSeguridad, getParametroPuertoCorreo, getParametroCorreoServidor } from '../controllers/parametros-controller';
...
routerParametros.get('/getParametroPuertoCorreo', getParametroPuertoCorreo);//Obtiene en los parámetros el puerto del Host para enviar correos
routerParametros.get('/getParametroCorreoServidor', getParametroCorreoServidor);//Obtiene en los parámetros el correo del Host para enviar correos
